...
const CardFilmHero:FC<FilmCards> = ({id,name, title, image}) => {
...
return (
 ...
 <div className="col-span-full">
                        <div data-id={id} className="w-full relative">
                            ...
                            >
                                <h1
                                    className="text-2xl sm:text-4xl lg:text-5xl font-bold leading-12 mb-0.5 sm:mb-3 md:mb-3 lg:mb-6 text-white font-myFont"
                                >
                                    {name}
                                </h1>
                                <p
                                    className="w-full sm:w-8/12 md:w-6/12 lg:w-5/12 text-sm sm:text-sm lg:text-p font-normal font-myFont text-white line-clamp-2 sm:line-clamp-3 lg:line-clamp-3"
                                >
